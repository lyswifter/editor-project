...
const TerminalWelcomeMessage = ({ packageJson, storage }) => {
  return (
    <div className="remix_ui_terminal_block px-4 " data-id="block_null">Chain-Cloud IDE
      <div className="remix_ui_terminal_welcome"> Welcome to Chain-Cloud {packageJson} </div><br />
